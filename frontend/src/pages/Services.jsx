...
function Services() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#f3f7f5]">
      <div className="pointer-events-none absolute -top-24 left-1/2 h-64 w-64 -translate-x-1/2 rounded-full bg-emerald-200/60 blur-3xl" />
      ...
      <motion.section
        ...
        className="relative site-container section-space-tight text-center"
      >
        <p className="inline-flex items-center gap-2 text-xs tracking-[0.18em] uppercase text-emerald-700 font-bold bg-emerald-100 px-5 py-2.5 rounded-full mb-8">
          ✚ Excellence In Care
        </p>
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-slate-900 mb-6 leading-tight animate-text-rise">
          Our Healthcare <span className="text-emerald-700">Services</span>
        </h1>
